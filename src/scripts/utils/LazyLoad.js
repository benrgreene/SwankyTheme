 ...
 */
const createObservers = ({ toObserve, successCallback, errorCallback, margins, threshold, root }) => {
 ...
 */
export const setupObservers = ({ queryString = '[io-img-src], [io-img-srcset], [io-bg-src], [io-bg-srcset]', callback = setTileBackground, errorCallback = false, margins = '0% 0% 0% 0%', root = null, threshold = 0 } = {}) => {
